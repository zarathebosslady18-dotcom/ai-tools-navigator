...
### Stage & traction
> Pre-seed, no formal funding raised. Post-MVP on the core loop: the x402 payment flow, signature verification, agent runtime, budget guardrails, and settlement ledger are implemented and running (linked demo). `[FILL — any real numbers: merchant conversations, LOIs, waitlist, pilot SMEs. Even "X SMEs in active pilot discussions in Dubai" helps. If none: "first merchant pilots scheduled during the program — 10–20 UAE SMEs."]`

### Team
> `[FILL — names, roles, 1–2 lines each: relevant fintech/crypto/AI/ops background, and the UAE/GCC network we bring. Emphasize: the distribution edge no US cohort team has — first-principles access to MENA SME merchants.]`

### What will you do with the $100K and the 8 weeks?
> Weeks 1–2: live mainnet settlement (facilitator + merchant-submitted auths), CDP/Agentic Wallets integration, publish `@cart402/checkout` npm. Weeks 3–4: 10 live merchant endpoints (UAE digital services: NLP, OCR, data, booking), Agent Carts v2 (multi-step goals, refunds), **Agent Credit Bureau live** (5-factor score from the settlement ledger, x402-paid lender pulls — engine already built and running). Weeks 5–6: MENA beachhead — 10–20 UAE SME merchants onboarded, Arabic agent personas. Weeks 7–8: Agent.market listing, EAS attestation of credit scores, Demo Day: live mainnet autonomous shopping, merchant revenue + credit-score screen, pilot LOIs. Spend: ~55% engineering (incl. security review of the payment path), ~25% GTM/ecosystem, ~20% legal (UAE + Delaware) and one engineer.
...
| 68–80 | Face | "We're Dubai-based, which is our wedge: ~350,000 UAE/GCC SMEs with zero agentic-commerce infrastructure. We're taking agent commerce to the Gulf first — then global on Base rails." |
| 80–90 | Face | "The rails landed this year. Agentic Wallets, Coinbase for Agents, x402 under the Linux Foundation. What's missing is the commerce layer. That's what we've built — and it's running right now. We're Base-first, pre-seed, and ready for Batches 004." |
